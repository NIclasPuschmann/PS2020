...
class ClientSessionKeepAliveManager extends events_1.EventEmitter {
    ...
    start() {
        ...
        if (this.session.timeout < 600) {
            console.warn(`ClientSessionKeepAliveManager detected that the session timeout (${this.session.timeout} ms) is really too small: please adjust it to a greater value ( at least 1000))`);
        }
        /* istanbul ignore next*/
