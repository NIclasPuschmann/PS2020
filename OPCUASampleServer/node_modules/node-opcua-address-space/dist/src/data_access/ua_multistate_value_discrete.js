...
exports._addMultiStateValueDiscrete = exports.promoteToMultiStateValueDiscrete = exports.UAMultiStateValueDiscrete = void 0;
/**
...
register_node_promoter_1.registerNodePromoter(node_opcua_constants_1.VariableTypeIds.MultiStateValueDiscreteType, promoteToMultiStateValueDiscrete);
function _addMultiStateValueDiscrete(namespace, options) {
    ...
    let value;
    if (typeof options.value === "number" || node_opcua_basic_types_1.isValidUInt64(options.value)) {
        if (node_opcua_basic_types_1.isValidUInt64(options.value)) {
